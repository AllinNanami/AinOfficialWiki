...
function isSensitiveUrl(url: string): boolean {
  try {
    const parsed = new URL(url, SITE_URL)
    return parsed.pathname === '/sre/proxy-network-principles-202607' || parsed.pathname === '/sre/proxy-network-principles-202607/' || parsed.pathname === '/ai/coding-plan-hub' || parsed.pathname === '/ai/coding-plan-hub/'
  } catch {
    return false
  }
}
      ...
      '/ai/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'AI 领域信源汇总', link: '/ai/ai-information-sources-guide-202607' }
          ]
        },
        {
          text: '安全与合规',
