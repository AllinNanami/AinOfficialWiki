...
description: 从"AI 读科学"到"AI 做科学"，科研智能体的范式转变与完整版图。
author: snowboat (@snowboat84)
source: https://x.com/snowboat84/status/2070656715515932930
date: 2026-06-27
---

# AI for Science 详细介绍（上）：范式与版图

![封面图](https://gastigado.cnies.org/d/public/img_01.jpg)
...
![范式转变](https://gastigado.cnies.org/d/public/img_02.jpg)
...
![三类系统对比](https://gastigado.cnies.org/d/public/img_03.jpg)
...
![自治层级](https://gastigado.cnies.org/d/public/img_04.jpg)
...
![文献检索与知识合成](https://gastigado.cnies.org/d/public/img_07.jpg)
...
![自驾实验室](https://gastigado.cnies.org/d/public/img_05.jpg)
...
![A-Lab](https://gastigado.cnies.org/d/public/img_06.jpg)
...
![数据分析与复现](https://gastigado.cnies.org/d/public/img_08.jpg)
...
![科学基础模型](https://gastigado.cnies.org/d/public/img_09.jpg)
...
![学科版图](https://gastigado.cnies.org/d/public/img_10.jpg)
...
![资金分布逻辑](https://gastigado.cnies.org/d/public/img_11.jpg)
...
科学的可信度建立在"他人能重复你的结果"之上。但这件事在AI之前就已经岌岌可危。2016年《自然》一项覆盖1576名研究者调查显示，超过七成的人无法复现别人的实验，超过一半的人连自己过去的结果都重复不出来。这是科学界长期的结构性问题。
...
这就是第四章反复强调的评估缺口。它有两层含义。第一层，基准与真实表现之间存在系统性落差，一个系统在某个某个静态基准上表现亮眼，不代表它在真实、动态、开放的科研环境里同样可靠。第二层，科学领域的专业评估本身严重不足，多个科学基准上最强模型的得分都远未达到专家水平（如ReplicationBench上复现得分很低），而绝大多数学科、子领域、任务类型甚至还没有自己的基准。
...
![自治幻觉](https://gastigado.cnies.org/d/public/img_12.png)
