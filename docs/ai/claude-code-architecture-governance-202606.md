...
requested_url: "https://x.com/HiTw93/status/2032091246588518683"
author: "Tw93 (@HiTw93)"
author_name: "Tw93"
author_username: "HiTw93"
author_url: "https://x.com/HiTw93"
tweet_count: 1
---

# 你不知道的 Claude Code：架构、治理与工程实践

![](./assets/claude-code-architecture-governance-202606/image1.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image2.jpg)

只强化其中一层，系统就会失衡，CLAUDE.md 写太长，上下文先污染自己了；工具堆太多了，选择就搞不清楚了；subagents 开得到处都是，状态就漂移了；验证这步跳过了，出了问题根本不知道是哪里挂的。

# 1. 它底层是怎么运行的

![](./assets/claude-code-architecture-governance-202606/image3.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image4.png)

对着这几个面看，很多问题就好排查了。结果不稳定，查上下文加载顺序，不是模型的事；自动化失控，看控制层有没有设计，不是 agent 太主动；长会话质量下降，中间产物把上下文污染了，换个新会话比反复调 prompt 有用得多。

![](./assets/claude-code-architecture-governance-202606/image5.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image6.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image7.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image8.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image9.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image10.jpg)

类型二：工作流型（标准化操作）

配置迁移高风险，显式调用 + 内置回滚步骤：

![](./assets/claude-code-architecture-governance-202606/image11.png)
...
![](./assets/claude-code-architecture-governance-202606/image12.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image13.jpg)

## Hooks：越早发现错误，越省时间

![](./assets/claude-code-architecture-governance-202606/image14.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image15.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image16.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image17.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image18.png)
...
![](./assets/claude-code-architecture-governance-202606/image19.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image20.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image21.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image22.jpg)
...
![](./assets/claude-code-architecture-governance-202606/image23.jpg)
