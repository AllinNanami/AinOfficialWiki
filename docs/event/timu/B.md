...
- Git学习教程：[https://ain.hmgf.hxcn.space/guides/sre/git-basics](https://ain.hmgf.hxcn.space/guides/sre/git-basics)
...
3. #### 双系统安装、软件安装、环境配置
  ...
  * 使用 WSL 安装 Ubuntu 教程：[/sre/first-vm-2024#使用-vmware-workstation-安装-ubuntu-22-04](/sre/first-vm-2024#使用-vmware-workstation-安装-ubuntu-22-04)
