...
<div class="vp-pro-breadcrumbs-demo">
  <Breadcrumbs
    :items="[
...
<style>
.vp-pro-breadcrumbs-demo :is(.vp-pro-breadcrumbs__link, .vp-pro-breadcrumbs__label, .vp-pro-breadcrumbs__current-trigger, .vp-pro-breadcrumbs__separator) {
  align-self: center;
  vertical-align: middle;
}

.vp-pro-breadcrumbs-demo .vp-pro-breadcrumbs__separator {
  line-height: 1;
}
</style>
