...
###  用Bbox扩展设置背景颜色 Setting background color with Bbox
Bbox扩展是一款自定义宏包，如需使用请在公式页面右上角【设置】处勾选后使用。
具体用法如下：
## 设置背景颜色 Setting Background color
...
## 调整背景大小 Setting Background Size
...
##  TeX扩展包使用 TeX and LaTeX extensions
...
via: [https://github.com/QianJianTech/LaTeXLive/blob/master/README.md](https://github.com/QianJianTech/LaTeXLive/blob/master/README.md)
