...
<DocOverview back-href="/resource/" back-label="返回资源">
  ...
  <DocOverviewGroup id="布局与导航" title="布局与导航" description="适合做页面结构、模块切换和信息导览。">
  ...
  <DocOverviewGroup id="内容展示" title="内容展示" description="适合强化信息可读性和技术文档表达。">
  ...
  <DocOverviewGroup id="表单与反馈" title="表单与反馈" description="适合用户输入、状态展示和局部浮层交互。">
