...
<div v-click class="mt-4 text-center text-base text-gray-500">
...
**(b•̀ω•́)b 个人认为 Gemini 2.5 Pro 是目前最好用的 AI！)**
...
但豆包**"多而不精"**，在面对一些复杂问题时，还是选其他几款 AI 比较好~ (´・ω・`)
...
<div class="p-6 bg-green-50 dark:bg-green-900 rounded">
